  ...
  private createAiPanelElement() {
    ...
    container.innerHTML = `
        <div class="aie-ai-panel-body">
            <div class="aie-ai-panel-body-content" style="display: none"><div class="loader">${Svgs.refresh}</div><textarea id="textarea" readonly></textarea></div>
      ...
      if (aiModel) {
        ...
        aiModel.chat(selectedText, prompt, {
          onStart(aiClient) {
            ...
            container.querySelector<HTMLElement>(".actions")!.style.display =
              "none";
            container.querySelector<HTMLElement>(".loader")!.style.display =
              "block";
